...
class Book:
    ...
    def get_all(cls):
        ...
        books = []
        results = MySQLConnection('books_schema').query_db(query)
        for row in results:
    ...
    def save(cls,data):
        ...
        return MySQLConnection('books_schema').query_db(query,data)
    ...
    def get_by_id(cls,data):
        ...
        results = MySQLConnection('books_schema').query_db(query,data)
        ...
        for row in results:
            ...
            # Changed this with cameron because theres no need to import it twice once uptop
            # book.authors_who_favorited.append(author.Author(data))
            book.authors_who_favorited.append(Author(data))
        return book
